@extends('layouts.admin',['title' => 'Student'])
@section('body')
<div class="row">
    <div class="col s12">
        <div class="card">
            <div class="card-content">
                ...
                @if ($students->count() < 1)
                <p class="red-text center my-5 ">NO student found</p>
                @else
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div style="width: 70px;height:70px; border-radius:50%; overflow:hidden" class="z-depth-1">
                                ...
                                <img data-src="{{ asset('storage/'.$student->profile) }}" width="100%" class="lazy">
                            </div></td>
                            <td>{{ $student->name }}</td>
                            ...
                            <td>
                                <div style="display: inline-flex;">
                                    ...
                                    <a href="{{ route('student.edit', $student->id) }}"  class="btn btn-small btn-floating transparent z-debth">
                ...
                <br>
                @endif
                <a href="{{ route('student.create') }}" class="btn waves-effect btn-floating mx-5 my-5 btn-large transparent">
